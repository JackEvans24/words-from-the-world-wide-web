...
namespace WordClassBuilder
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            driver.Url = "http://listofrandomwords.com/";

            driver.FindElement(By.Name("lst_howmany")).SendKeys(Keys.Delete + Keys.Delete + "100");
            driver.FindElement(By.ClassName("btn-primary")).Click();
            
            foreach (IWebElement word in driver.FindElement(By.ClassName("abox")).FindElements(By.CssSelector("li")))
            {
                if (!RandomWord.words.Contains(word.Text))
                {
                    wordsToAdd += "\"" + word.Text + "\", ";
                    counter++;
                    if (counter % 10 == 0)
                        wordsToAdd += "\r\n";
                }
                else
                    Console.WriteLine("Already contains " + word.Text);
            }
    ...
    public class RandomWord
    {
        public static List<string> words = new List<string> {
            ...
            "flag", "bulb", "rod", "tan", "drip", "oxidize", "newsagent", "crenellating", "literalizer", "jos", "wearied",
            "convivially", "forlorn", "umlaut", "overeditorializing", "frocking", "frotteur", "protophloem", "congenital",
            "crazier", "pseudogeneric", "barney", "transcription", "dissolvingly", "flaunt", "nonassigned", "amosite", "wishfully", "dowerless",
            "galvanizing", "gator", "phyllody", "chrysomelid", "untwined", "fumitory", "itemised", "fba", "blastment",
            "episcopally", "tesselated", "soong", "choky", "sublecturer", "irreversible", "overexcited", "pyogenic", "finespun", 
            "amidst", "oxytocin", "adjudge", "presecured", "clench", "ungalvanized", "tar", "classicist", "underhung",
            "amphibole", "settlings", "cairn", "swatter", "barometer", "antefix", "trilateral", "quaver", "unfabulous",
            "perspicuous", "elope", "noncompulsion", "unclimaxed", "wilier", "anastigmatic", "architectonic", "punchball", "reciprocal", "feral",
            "exhibitor", "reprobate", "dolomite", "misconceiving", "transmutation", "inclusive", "unenviable", "commensurable", "oxalate", "bouchon",
            "programming", "bozo", "manual", "tying", "virile", "prefatory", "creative", "cessative", "duplicated", "reckon", "filament",
            "nasal", "humiliation", "produced", "formication", "poet", "athetosis",
            "overshirt", "ochlophobia", "pyretic", "paleolithic", "incipiency", "fluoridated", "mispunctuating", "reworking",
            ...
            "slide", "bombï¿¥ï¾½", "onalaska", "infantry", "haematopoietic", "candidly", "narew", "chemigrapher", "pleb", "palaeogenesis",
